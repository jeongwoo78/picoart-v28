...
const chineseArtworks = [
  ...
  {id:'chinese_02',title:'궁녀도',artist:'주방',subjects:['people','women','portraits'],colors:['soft pastels','earth tones'],mood:'elegant',style:'figure painting',prompt:'Chinese gongbi court ladies painting style, CRITICAL GENDER PRESERVATION: if photo shows male keep masculine features with beard, if photo shows female keep feminine features, elegant graceful figures, delicate fine facial features, flowing robes, soft harmonious colors, extremely detailed brushwork, refined imperial court painting quality, ABSOLUTELY PRESERVE ORIGINAL GENDER, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese ukiyo-e, this is PURE CHINESE ART'},
...
const koreanArtworks = [
  ...
  {id:'korean_03',title:'단오풍정',artist:'신윤복',subjects:['festival','people','celebration'],colors:['vibrant colors'],mood:'joyful',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok Joseon Dynasty Pungsokdo genre painting, Dano festival scene with Korean people in colorful hanbok outdoors, CRITICAL: if photo shows men keep male features, if photo shows women keep female features, PRESERVE EACH PERSON ORIGINAL GENDER, vibrant festive atmosphere, narrative storytelling of Korean daily life, painted on hanji with mineral pigments, KOREAN GENRE PAINTING tradition unique to Joseon Korea, absolutely NOT Chinese court formality, absolutely NOT Japanese ukiyo-e entertainment, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, this is PURE KOREAN ART'},
  {id:'korean_04',title:'월하정인',artist:'신윤복',subjects:['people','romance','night','couple'],colors:['soft colors','moonlit tones'],mood:'romantic',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok romantic moonlight Pungsokdo genre painting, Joseon Dynasty style, CRITICAL FOR COUPLE: if photo shows man and woman BOTH genders must be preserved - male stays masculine with beard, female stays feminine, Korean figures in hanbok under moonlight, soft refined colors with ink washes, intimate romantic narrative, ABSOLUTELY PRESERVE BOTH GENDERS SEPARATELY, KOREAN ROMANTIC GENRE PAINTING tradition, absolutely NOT Chinese scholar painting, absolutely NOT Japanese ukiyo-e drama, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, this is PURE KOREAN ART'},
