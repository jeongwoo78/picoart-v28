...
// 속도 최적화 (24 steps) + 성별 보존 + 일본어 차단

// 동양화 DB
const chineseArtworks = [
  {id:'chinese_01',title:'천리강산도',artist:'왕희맹',subjects:['mountains','rivers','nature'],colors:['blue','green','gold'],mood:'majestic',style:'blue-green landscape',prompt:'Chinese blue-green landscape painting (Qinglu Shanshui) style by Wang Ximeng, grand panoramic mountains and rivers, brilliant blue and green mineral pigments, golden aged paper, meticulous detailed gongbi technique, imperial court painting quality, majestic serene atmosphere, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese ukiyo-e, this is PURE CHINESE ART'},
  {id:'chinese_02',title:'궁녀도',artist:'주방',subjects:['people','women','portraits'],colors:['soft pastels','earth tones'],mood:'elegant',style:'figure painting',prompt:'Chinese gongbi court painting style, ABSOLUTELY CRITICAL FOR EACH INDIVIDUAL PERSON: analyze photo and identify each person gender separately, male person MUST stay male with masculine face jaw and body structure, female person MUST stay female with feminine features, DO NOT change any male to female appearance, DO NOT feminize any male faces, preserve exact gender and facial characteristics of EVERY SINGLE PERSON from original photo, elegant graceful figures, delicate fine facial features, flowing robes, soft harmonious colors, extremely detailed brushwork, refined imperial court painting quality, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese ukiyo-e, this is PURE CHINESE ART'},
  ...
  {id:'chinese_09',title:'미인도',artist:'당인',subjects:['women','portraits','beauty'],colors:['soft colors','pastels'],mood:'refined',style:'beauty portrait',prompt:'Chinese gongbi beauty portrait style, ABSOLUTELY CRITICAL GENDER RULE: if photo shows male person KEEP MALE with strong masculine face and jaw structure, if photo shows female person KEEP FEMALE with feminine features, DO NOT feminize male faces, DO NOT change gender, preserve exact gender and all facial characteristics from original photo, elegant refined figure, delicate detailed facial features, soft harmonious colors, fine silk texture rendering, graceful posture, traditional Chinese painting quality, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese ukiyo-e bijinga, this is PURE CHINESE ART'},
  ...
  {id:'chinese_16_general',title:'장군 초상',artist:'명대',subjects:['men','male','general','warrior','portraits'],colors:['rich colors','armor colors'],mood:'dignified',style:'military portrait',prompt:'Chinese Ming Dynasty general warrior portrait, MASCULINE MALE ONLY STRICTLY ENFORCED, strong dignified Chinese military commander in armor and helmet, powerful masculine face with full beard mustache and goatee, fierce warrior expression, military strength and authority, traditional Chinese general portrait quality, ABSOLUTELY PRESERVE MALE GENDER AND MASCULINE FEATURES, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese style, this is PURE CHINESE ART'}
];

const koreanArtworks = [
  {id:'korean_01',title:'미인도',artist:'신윤복',subjects:['women','beauty','portraits'],colors:['soft pastels'],mood:'elegant',style:'beauty portrait',prompt:'Korean Hyewon Shin Yunbok Joseon Dynasty Pungsokdo genre painting beauty portrait, CRITICAL GENDER PRESERVATION: preserve original facial features and gender from photo exactly as shown, delicate refined brushwork showing elegant figure in hanbok, soft pastel colors unique to Korean aesthetic, gentle contemplative expression, painted on hanji paper, ABSOLUTELY PRESERVE ORIGINAL GENDER AND ALL FACIAL CHARACTERISTICS, KOREAN GENRE PAINTING not Chinese gongbi court ladies, absolutely NOT Japanese ukiyo-e bijinga, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NO Japanese calligraphy style, this is PURE KOREAN ART'},
  {id:'korean_02',title:'까치호랑이',artist:'민화',subjects:['tiger','magpie','animals'],colors:['bright colors','bold outlines'],mood:'cheerful',style:'folk painting',prompt:'Korean Minhwa folk painting style, THICK BOLD BLACK OUTLINES around every shape (critical feature), BRIGHT PRIMARY colors from Obangsaek (red blue yellow white black), completely FLAT naive composition, childlike playful humorous tiger and magpie, painted by Korean common folk NOT professional artists, ABSOLUTELY NOT elegant Chinese painting, ABSOLUTELY NOT sophisticated Japanese ukiyo-e, this bold outline naive style is UNIQUELY KOREAN, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, this is PURE KOREAN ART'},
  {id:'korean_03',title:'단오풍정',artist:'신윤복',subjects:['festival','people','men','women','celebration','group'],colors:['vibrant colors'],mood:'joyful',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok Joseon Dynasty Pungsokdo genre painting, Dano festival scene with Korean people in colorful hanbok outdoors, ABSOLUTELY CRITICAL FOR EACH INDIVIDUAL PERSON: carefully analyze photo and identify each person gender separately, male person MUST remain male with masculine face and body, female person MUST remain female with feminine face and body, DO NOT feminize male faces, DO NOT masculinize female faces, preserve exact gender and facial characteristics of EVERY SINGLE PERSON from original photo, vibrant festive atmosphere, narrative storytelling of Korean daily life, painted on hanji with mineral pigments, KOREAN GENRE PAINTING tradition unique to Joseon Korea, absolutely NOT Chinese court formality, absolutely NOT Japanese ukiyo-e entertainment, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, this is PURE KOREAN ART'},
  {id:'korean_04',title:'월하정인',artist:'신윤복',subjects:['people','romance','couple'],colors:['soft colors'],mood:'romantic',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok romantic Pungsokdo genre painting, Joseon Dynasty style, CRITICAL FOR COUPLE: preserve original facial features and gender from photo - if man keep masculine face, if woman keep feminine face, BOTH genders must be preserved separately, Korean figures in hanbok, soft refined colors with ink washes, intimate romantic narrative, preserve photo background atmosphere, ABSOLUTELY PRESERVE EACH PERSON ORIGINAL GENDER AND FACIAL CHARACTERISTICS, KOREAN ROMANTIC GENRE PAINTING tradition, absolutely NOT Chinese scholar painting, absolutely NOT Japanese ukiyo-e drama, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, this is PURE KOREAN ART'},
  {id:'korean_05',title:'모란도',artist:'민화',subjects:['peony','birds','flowers'],colors:['rich vibrant colors'],mood:'prosperous',style:'folk flower',prompt:'Korean Minhwa folk painting PEONY flowers, PRESERVE photo composition, THICK BLACK OUTLINES around all shapes, BRIGHT PRIMARY colors from Obangsaek, completely FLAT decorative naive composition, prosperity symbolism, DISTINCTLY KOREAN MINHWA not refined Chinese Huaniao, absolutely NOT elegant Japanese flower prints, NO anime, NO added characters, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), this is PURE KOREAN ART'},
  {id:'korean_06',title:'책거리',artist:'민화',subjects:['books','stationery','still life','scholar objects'],colors:['bright colors','colorful patterns'],mood:'scholarly',style:'folk still life',prompt:'Korean Minhwa Chaekgeori folk painting scholar objects still life, THICK BLACK OUTLINES, stacked books and objects, BRIGHT decorative colors, FLAT impossible perspective, geometric ornate patterns, uniquely KOREAN folk genre, ABSOLUTELY NOT Chinese scholar paintings, ABSOLUTELY NOT Japanese screens or byobu, this is PURELY KOREAN STYLE with Korean aesthetics, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) MAY appear on book spines only as text NOT as decorative element, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese decorative elements, NO Japanese artistic style, NO Japanese text format, this is PURE KOREAN ART'},
  {id:'korean_07',title:'맹호도',artist:'조선시대',subjects:['tiger','fierce','animal','pine tree'],colors:['black ink','brown','aged paper'],mood:'powerful',style:'realistic animal',prompt:'Korean Joseon Dynasty fierce tiger painting Maenghodo, realistic powerful Korean tiger under pine tree, detailed fur texture, monochrome ink with subtle brown on aged hanji, dignified guardian symbolism, bold expressive Korean brushwork, KOREAN TIGER PAINTING tradition, absolutely NOT Chinese decorative tigers, absolutely NOT Japanese stylized tigers, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), this is PURE KOREAN ART'},
  {id:'korean_08',title:'인왕제색도',artist:'정선',subjects:['mountains','rocks','landscape'],colors:['black ink','grey'],mood:'powerful',style:'true-view landscape',prompt:'Korean Jeong Seon Jingyeong Sansu true-view landscape, bold powerful Inwangsan rocky mountains of Korea, dramatic EXPRESSIVE brushwork unique to Korean landscape tradition, monochrome ink with bold angular forms, REAL Korean scenery not idealized Chinese mountains, revolutionary Korean style rejecting Chinese conventions, absolutely NOT Chinese literati landscapes, absolutely NOT Japanese decorative landscapes, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), this is PURE KOREAN ART'},
  {id:'korean_09',title:'화조도',artist:'조선시대',subjects:['flowers','birds','nature'],colors:['natural harmonious colors'],mood:'harmonious',style:'flower bird',prompt:'Korean Joseon Dynasty Hwajodo flower-bird painting, PRESERVE photo composition, harmonious naturalistic composition, natural elegant colors, refined brushwork on hanji, Korean aesthetic sensibility, peaceful contemplative mood, KOREAN FLOWER-BIRD tradition, absolutely NOT Chinese decorative Huaniao, absolutely NOT Japanese bold bird prints, NO anime, NO added characters, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), this is PURE KOREAN ART'},
  {id:'korean_10',title:'씨름',artist:'김홍도',subjects:['sport','wrestling','people','men','male','group','action'],colors:['natural earth tones'],mood:'lively',style:'genre painting',prompt:'Korean Danwon Kim Hongdo Pungsokdo genre painting, dynamic Ssireum wrestling action capturing intense moment, CRITICAL GENDER PRESERVATION: preserve original masculine features and facial characteristics from photo - strong build, masculine faces, lively crowd of Korean men, natural earth tones, energetic composition showing Korean folk culture and sports, painted on hanji with swift brushwork, ABSOLUTELY PRESERVE MALE GENDER AND FACIAL CHARACTERISTICS, ICONIC KOREAN GENRE PAINTING of common people daily life, Joseon Dynasty social documentation, absolutely NOT Chinese court paintings, absolutely NOT Japanese sumo scenes, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), this is PURE KOREAN ART'}
];
...
- Chinese characters (漢字) are ALLOWED as text only
- Japanese hiragana (ひらがな) is ABSOLUTELY FORBIDDEN
- Japanese katakana (カタカナ) is ABSOLUTELY FORBIDDEN  
...
Return ONLY valid JSON (no markdown):
{
  ...
  "prompt": "Complete FLUX prompt starting with 'Chinese [style name] style, [detailed characteristics]... Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Japanese ukiyo-e, this is PURE CHINESE ART'"
}
