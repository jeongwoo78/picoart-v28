...
const chineseArtworks = [
  ...
  {id:'chinese_02',title:'궁녀도',artist:'주방',subjects:['people','women','portraits'],colors:['soft pastels','earth tones'],mood:'elegant',style:'figure painting',prompt:'Chinese gongbi court ladies painting style, CRITICAL GENDER PRESERVATION: if photo shows male preserve masculine features and facial structure, if photo shows female preserve feminine features, elegant graceful figures, delicate fine facial features, flowing robes, soft harmonious colors, extremely detailed brushwork, refined imperial court painting quality, ABSOLUTELY PRESERVE ORIGINAL GENDER AND FACIAL CHARACTERISTICS, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese ukiyo-e, this is PURE CHINESE ART'},
  ...
  {id:'chinese_09',title:'미인도',artist:'당인',subjects:['women','portraits','beauty'],colors:['soft colors','pastels'],mood:'refined',style:'beauty portrait',prompt:'Chinese gongbi beauty portrait style, CRITICAL GENDER PRESERVATION: preserve original facial features and gender from photo exactly as shown, elegant refined figure, delicate detailed facial features, soft harmonious colors, fine silk texture rendering, graceful posture, traditional Chinese beauty painting quality, ABSOLUTELY PRESERVE ORIGINAL GENDER AND ALL FACIAL CHARACTERISTICS, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese ukiyo-e bijinga, this is PURE CHINESE ART'},
...
const koreanArtworks = [
  ...
  {id:'korean_04',title:'월하정인',artist:'신윤복',subjects:['people','romance','night','couple'],colors:['soft colors','moonlit tones'],mood:'romantic',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok romantic moonlight Pungsokdo genre painting, Joseon Dynasty style, CRITICAL FOR COUPLE: preserve original facial features and gender from photo - if man keep masculine face, if woman keep feminine face, BOTH genders must be preserved separately, Korean figures in hanbok under moonlight, soft refined colors with ink washes, intimate romantic narrative, ABSOLUTELY PRESERVE EACH PERSON ORIGINAL GENDER AND FACIAL CHARACTERISTICS, KOREAN ROMANTIC GENRE PAINTING tradition, absolutely NOT Chinese scholar painting, absolutely NOT Japanese ukiyo-e drama, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, this is PURE KOREAN ART'},
      ...
      'https://api.replicate.com/v1/models/black-forest-labs/flux-depth-dev/predictions',
      {
        ...
        body: JSON.stringify({
          input: {
            ...
            control_strength: 0.65,         // 구도 유지 강도
            output_format: 'jpg',
            output_quality: 90
          }
        })
