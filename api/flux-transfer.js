...
const chineseArtworks = [
  ...
  {id:'chinese_02',title:'궁녀도',artist:'주방',subjects:['people','women','portraits'],colors:['soft pastels','earth tones'],mood:'elegant',style:'figure painting',prompt:'Chinese gongbi court painting style, ABSOLUTELY CRITICAL GENDER RULE: male person in photo MUST stay male with masculine face structure and features, female person MUST stay female with feminine features, DO NOT change male to female appearance, DO NOT feminize male faces, preserve exact gender and facial characteristics from original photo, elegant graceful figures, delicate fine facial features, flowing robes, soft harmonious colors, extremely detailed brushwork, refined imperial court painting quality, Chinese characters allowed as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, NOT Korean style, NOT Japanese ukiyo-e, this is PURE CHINESE ART'},
...
const koreanArtworks = [
  ...
  {id:'korean_03',title:'단오풍정',artist:'신윤복',subjects:['festival','people','men','women','celebration','group'],colors:['vibrant colors'],mood:'joyful',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok Joseon Dynasty Pungsokdo genre painting, Dano festival scene with Korean people in colorful hanbok outdoors, CRITICAL GENDER PRESERVATION: preserve original facial features and gender of each person from photo exactly as shown - men stay masculine, women stay feminine, vibrant festive atmosphere, narrative storytelling of Korean daily life, painted on hanji with mineral pigments, ABSOLUTELY PRESERVE EACH PERSON ORIGINAL GENDER AND FACIAL CHARACTERISTICS, KOREAN GENRE PAINTING tradition unique to Joseon Korea, absolutely NOT Chinese court formality, absolutely NOT Japanese ukiyo-e entertainment, ALLOWED CHARACTERS: Korean Hangul (한글) and Chinese characters (漢字) as text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text format, this is PURE KOREAN ART'},
